...
$reportPath = "c:\Users\Admin\.gemini\Workspaces\Email Systems\spine\auth_report.html"
$screenshotPath = "c:\Users\Admin\.gemini\Workspaces\Email Systems\spine\auth_report.png"
...
try {
    $wshell.AppActivate("UMP-20-05 Verification")
}
catch {
