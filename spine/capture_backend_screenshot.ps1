...
$reportPath = "c:\Users\Admin\.gemini\Workspaces\Email Systems\spine\backend_report.html"
$screenshotPath = "c:\Users\Admin\.gemini\Workspaces\Email Systems\spine\backend_report.png"
