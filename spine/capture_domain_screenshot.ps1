...
$reportPath = "c:\Users\Admin\.gemini\Workspaces\Email Systems\spine\domain_report.html"
$screenshotPath = "c:\Users\Admin\.gemini\Workspaces\Email Systems\spine\domain_report.png"
...
try {
    $wshell.AppActivate("UMP-20-06 Verification")
}
catch {
