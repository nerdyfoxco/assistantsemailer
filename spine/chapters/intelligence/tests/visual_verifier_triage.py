...
def generate_report():
    ...
    <html>
    <head>
        <title>UMP-50-02 Verification</title>
        <style>
    ...
    <body>
        <div class="card">
            <h1>UMP-50-02: Triage Logic (In-Memory)</h1>
            <div class="badge">{status_text} (10/10 Tests)</div>
            <p><strong>Timestamp:</strong> {datetime.datetime.now()}</p>
            <p><strong>Verification:</strong> 10-Test Protocol (Schema, UTC, Spam, VIP)</p>
    ...
    output_path = os.path.abspath("spine/chapters/intelligence/tests/triage_report.html")
