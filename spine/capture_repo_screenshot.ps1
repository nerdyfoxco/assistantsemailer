...
$reportPath = "c:\Users\Admin\.gemini\Workspaces\Email Systems\spine\repo_report.html"
$screenshotPath = "c:\Users\Admin\.gemini\Workspaces\Email Systems\spine\repo_report.png"
...
try {
    $wshell.AppActivate("UMP-20-03 Verification")
}
catch {
