...
$reportPath = "c:\Users\Admin\.gemini\Workspaces\Email Systems\spine\api_report.html"
$screenshotPath = "c:\Users\Admin\.gemini\Workspaces\Email Systems\spine\api_report.png"
...
try {
    $wshell.AppActivate("UMP-20-04 Verification")
}
catch {
