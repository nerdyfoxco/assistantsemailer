...
$reportPath = "c:\Users\Admin\.gemini\Workspaces\Email Systems\spine\db_report.html"
$screenshotPath = "c:\Users\Admin\.gemini\Workspaces\Email Systems\spine\db_report.png"
...
try {
    $wshell.AppActivate("UMP-20-02 Verification")
}
catch {
