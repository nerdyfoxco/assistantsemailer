...
$reportPath = "c:\Users\Admin\.gemini\Workspaces\Email Systems\spine\workflow_report.html"
$screenshotPath = "c:\Users\Admin\.gemini\Workspaces\Email Systems\spine\workflow_report.png"
...
# Try to bring to front by Title
Write-Host "Focusing window by title..."
try {
    $wshell.AppActivate("UMP-20-07 Verification")
}
catch {
